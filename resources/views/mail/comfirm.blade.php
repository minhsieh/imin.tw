...
<head>
  ...
  <style type="text/css" media="screen">
      @media screen {
        ...
        /* Thanks Outlook 2013! */
        * {
          font-family: 'Source Sans Pro', 'Helvetica Neue', 'Arial', 'sans-serif',Microsoft JhengHei !important;
        }
        .w280 {
          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="text-align: center;">
                <a href="#"><img class="w320" height="120" src="{{asset('assets/img/mail/logo.png')}}" alt="company logo" /></a>
              </td>
            </tr>
          </table>
